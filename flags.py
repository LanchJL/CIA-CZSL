...
parser.add_argument('--tem', type=float, default=20,help="Scale for cosine similarity")
parser.add_argument("--P_y",type=str,help="GCN|MLP")
parser.add_argument("--latent_dim2", default='768,1024,1200',help="layers dimensions")
